...
preventOverwrite = FALSE; # Required for this report which needs to be started twice (first time generates figures as external output while second call integrates them into report)
