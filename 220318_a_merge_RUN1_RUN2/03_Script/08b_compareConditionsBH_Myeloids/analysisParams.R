...
ANALYSIS_STEP_NAME = "08b_compareConditionsBH_Myeloids"
PATH_ANALYSIS_OUTPUT = file.path( PATH_PROJECT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Myeloids - Compare conditions"
...
MSIGDB_GMT_PATHS_MOUSE  = dir( file.path( PATH_PROJECT_REFERENCEDATA, 
                                         "msigdb_gmt",
                                         "mus_musculus"),
                              full.names = TRUE)

MSIGDB_GMT_PATHS_HUMAN = dir( file.path( PATH_PROJECT_REFERENCEDATA, 
                                         "msigdb_gmt",
                                         "homo_sapiens"),
                              full.names = TRUE)
