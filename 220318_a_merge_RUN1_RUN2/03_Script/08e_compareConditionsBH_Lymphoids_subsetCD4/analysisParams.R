...
ANALYSIS_STEP_NAME = "08e_compareConditionsBH_Lymphoids_subsetCD4"
PATH_ANALYSIS_OUTPUT = file.path( PATH_PROJECT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Lymphoids_subsetCD4 - Compare conditions"
...
PATH_RDS_SEURAT_OBJECT = file.path( PATH_PROJECT_OUTPUT, 
                                    ...
                                    "scRNAseq_sarcoma_220318_a_merge_RUN1_RUN2_seuratObject_subset_CD4.RDS")
