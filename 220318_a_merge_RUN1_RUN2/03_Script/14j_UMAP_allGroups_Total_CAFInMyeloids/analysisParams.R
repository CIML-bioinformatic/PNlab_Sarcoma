...
ANALYSIS_STEP_NAME = "14j_UMAP_allGroups_Total_CAFInMyeloids"
PATH_ANALYSIS_OUTPUT = file.path( PATH_PROJECT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Total - UMAP all subgroups"
...
EXTERNAL_CLUSTERING_PATH = c( file.path( PATH_PROJECT_OUTPUT, 
                              ...
                              file.path( PATH_PROJECT_OUTPUT, 
                                      "04i_groupClusters_Others_noAmbiguous", 
