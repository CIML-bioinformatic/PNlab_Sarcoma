...
```{r rmd_chisquare_test_clusters_HTO_plotResidualsAndContributions, fig.dim = c(18, 13)}
...
```{r rmd_chisquare_test_clusters_HTO_plotMosaic, fig.dim = c(11, 9)}
...
### No labels {.tabset .tabset-fade .tabset-pills}
<!-- #### Interactive -->
<!-- ```{r rmd_plotDimReducInteractive_colorClusters} -->
<!-- dimReducWidth  = 950; -->
<!-- dimReducHeight = 800; -->
...
### legend no labels {.tabset .tabset-fade .tabset-pills}
<!-- #### Interactive -->
<!-- ```{r rmd_plotDimReducInteractive_colorClusters} -->
<!-- dimReducWidth  = 950; -->
<!-- dimReducHeight = 800; -->
...
<!-- #### Raster -->
```{r rmd_plotDimReducRaster_colorClusters_legend_nolabels, fig.dim = c(11, 8)}
showDimReducClusterLabels = FALSE;
showLegend = TRUE;
<<plotDimReducRaster_colorClusters>>
rm(showDimReducClusterLabels);
