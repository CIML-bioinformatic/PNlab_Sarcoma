...
previousResultsEnv = new.env() # Load in separate environment to prevent overwriting critical variables specific to current analysis step (e.g. output path defined in anaysisParams)
