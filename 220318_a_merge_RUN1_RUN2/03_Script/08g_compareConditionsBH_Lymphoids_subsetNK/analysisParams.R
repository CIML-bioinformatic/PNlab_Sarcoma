...
ANALYSIS_STEP_NAME = "08g_compareConditionsBH_Lymphoids_subsetNK"
PATH_ANALYSIS_OUTPUT = file.path( PATH_PROJECT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Lymphoids_subsetCD8 - Compare conditions"
...
#Path to Seurat object (from previous analysis steps). Take the subset object from global experiment
...
HTO_DIFFEXP_FORCE_ADJUST_PVAL_BH = TRUE # Default is Bonferroni (conservative method), TRUE to recompute using BH
...
#MONITORED_GENES = as.list( read.table( file.path( PATH_PROJECT_REFERENCEDATA, "markers_211026.tsv"),
#                                       sep = "\t",
#                                       header = TRUE,
