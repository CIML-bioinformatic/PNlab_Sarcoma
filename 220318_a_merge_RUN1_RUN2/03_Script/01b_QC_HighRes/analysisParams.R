...
ANALYSIS_STEP_NAME = "01b_QC_HighRes"
...
PATH_10XFILES = c( "RUN1_CDNA1" = file.path( PATH_PROJECT_RAWDATA,
                                             "RUN1_CDNA1_filtered_feature_bc_matrix"),
                   "RUN1_CDNA2" = file.path( PATH_PROJECT_RAWDATA,
                                             "RUN1_CDNA2_filtered_feature_bc_matrix"),
                   "RUN2_CDNA1" = file.path( PATH_PROJECT_RAWDATA,
                                             "RUN2_CDNA1_filtered_feature_bc_matrix"),
                   "RUN2_CDNA2" = file.path( PATH_PROJECT_RAWDATA,
                                             "RUN2_CDNA2_filtered_feature_bc_matrix"))
...
NBCORES = 1;# Set to 1 to prevent an error about memory space when working on merged dataset (could also modify 'future' default if needed)
...
FINDMARKERS_SHOWTOP   = 25;       # Number of marker genes to show in report and tables (NULL for all)
