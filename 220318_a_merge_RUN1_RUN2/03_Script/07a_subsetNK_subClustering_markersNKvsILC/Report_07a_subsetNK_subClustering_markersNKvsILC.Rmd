...
# Disable warning regarding generation of random number with future (not handled by Seurat3)
# See: https://www.r-bloggers.com/2020/09/future-1-19-1-making-sure-proper-random-numbers-are-produced-in-parallel-processing/
...
```{r rmd_chisquare_test_clusters_HTO_plotResidualsAndContributions, fig.dim = c(9, 6)}
