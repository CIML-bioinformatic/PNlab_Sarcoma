...
# analysis
#
ANALYSIS_STEP_NAME = "08a_compareConditionsBH_Lymphoids"
PATH_ANALYSIS_OUTPUT = file.path( PATH_PROJECT_OUTPUT, ANALYSIS_STEP_NAME)

LITERAL_TITLE = "Lymphoids - Compare conditions"
...
# Merge genes lists for CD4 and CD8 
MONITORED_GENES = as.list( rbind( read.table( file.path( PATH_PROJECT_REFERENCEDATA, 
                                                         "geneLists",
                                                         "genes_CD4.tsv"),
                                              sep = "\t",
                                              header = TRUE,
                                              ...
                                              row.names = NULL, 
                                              fill = TRUE),
                                  read.table( file.path( PATH_PROJECT_REFERENCEDATA, 
                                                         "geneLists",
                                                         "genes_CD8.tsv"),
                                              sep = "\t",
                                              header = TRUE,
...
MONITORED_GENES = lapply(MONITORED_GENES, unique)
